...
describe('PolymerBuild', function () {
  ...
  describe('run', function () {
    ...
    it('should create build for production', function () {
      ...
      (0, _chai.expect)(indexHtml).to.be.equal('<!DOCTYPE html><html><head><base href="/src/" /><script>const hello="world";hello.replace("world","foo");</script></head><body></body></html>\n');
    ...
    it('should create build for dev', function () {
      ...
      var indexHtml = _fs2.default.readFileSync('build/bundled/_index.html').toString();
      ...
      (0, _chai.expect)(indexHtml).to.be.equal('<!DOCTYPE html><html><head><base href="/src/build/bundled" /><script>const hello="world";hello.replace("world","foo");</script></head><body></body></html>\n');
